...
<html lang="en">
  <head>
    ...
    <script>
    function check(){
        var pw = document.querySelector('#1111');
        if(pw.value == "1111"){
            window.location.href = "./Admin_LoginPageIn"
        }
    }
    </script>
  </head>
                                ...
                                <form action>	<!--  = "./Admin_LoginPageIn"> -->
                                    ...
                                    <div class="form-group">
                                        <div class = "row">
                                            ...
                                            <div class = col-md-2>
                                                <label for="formGroupExampleInput">관리자 비밀번호</label>
                                            </div>
                                            <div class = col-md-6>
                                                <input name = AdminPW id="AdminPW" type="password" class="form-control" id="exampleInputPassword1" placeholder="비밀번호를 입력하세요!!">
                                            </div>
                                            <div class = col-md-2> </div>
                                        </div>
                                    </div>
                                    </form>
                                    <button type="submit" class="btn btn-primary" onclick="check()">관리자 로그인 페이지로</button>
