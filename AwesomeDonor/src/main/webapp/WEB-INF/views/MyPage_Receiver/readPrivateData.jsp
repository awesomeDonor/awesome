...
<body style="height: 100%; margin: 0; padding: 0;">
 <div class="container">
   ...
   <div class = col-1></div>
    <div class="col-8">
		<div id="upborder" style=" margin: 30px 0px 0px 0px; width: 650px; height: 20px; border-radius: 5px 5px 0px 0px; background-color:#B4A8A1;"></div>
    	<div id="designBorder" style=" margin: 0px 0px 40px 0px; border-radius: 0px 0px 5px 5px; width: 650px; background-color: #DBD7D0; height: 650px; border: 4px solid #B4A8A1; ">  
    		<div id="tablebox" style="width: 600px; height: 600px; margin: 25px 10px 10px 25px; text-align: left; color:#736663;">
    			...
    			<div class = "row">
    				...
    				<div class = col-8> 
    					<div class="form-control" id="amount" placeholder="" disabled>
    					${dto.member_Receiver_phoneNumber }
    					</div>
    				</div>
    				<div class = col-1></div>
    			</div>
    			...
    			<div class = "row">
    				...
    				<div class = col-8> 
    					<div class="form-control" id="amount" placeholder="" disabled>
    					${dto.member_Receiver_websiteUrl }
    					</div>
    				</div>
    				<div class = col-1></div>
    			</div>
    			<div class="row">
                    ...
                    <div class="col-8" >
                          <textarea class="form-control" id="content" rows="4" placeholder="" disabled>${dto.member_Receiver_introduction }</textarea>
                    </div>
                    <div class = col-1></div>
                </div>
				<br>
                ...
                <div class = row>
					...
					<div class = col-2><a class="btn btn-success" href="./updateReceiverPrivateData_Page?Member_Receiver_idx=${dto.member_Receiver_idx }">수정</a></div>
				</div>
