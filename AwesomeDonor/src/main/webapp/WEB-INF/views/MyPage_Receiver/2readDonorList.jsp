...
<html lang="ko-kr">
  <head>
   ...
   body {
    ...
    <title>기본페이지-이걸 붙여넣기 하면 됨. </title>
  ...
  <div class="container">
    ...
    <jsp:include page="../receiverMyPageMenu.jsp"></jsp:include>
            <div class="col-9" id="right">
	            ...
	            <div class="col text-center"><h4 style="color:#736663;">후원 예약 상세내역</h4></div>
	            ...
	            <table class="table table-sm" style="font-size: 12px; color:#736663; text-align: center; ">
	                <thead style=" background-color: #80716817">
	                    ...
	                    <th scope="col" style="font-size: 13px; color:#736663;">평가</th>
	                    <th scope="col" style="font-size: 13px; color:#736663;">자세히보기</th>
	                    <th scope="col" style="font-size: 13px; color:#736663;">신청수락</th>
	                    </tr>
	                </thead>
	                <tbody>
	                	<c:forEach items="${boardData }" var="boardData">
							<tr>
							<th scope = row>${boardData.dto_Donor.member_Donor_name }</th>
							...
							<td>${boardData.countEvaluation}</td>
							<td><a href = "./readDetailDonorInfo?Donation_Action_idx=${boardData.dto_Donation_Action.donation_Action_idx }" class="btn btn-info btn-sm">자세히 보기</a></td><!--자세히 보기 -->
							<td><a href = "./donationAceept_Process?Donation_Action_idx=${boardData.dto_Donation_Action.donation_Action_idx}" class="btn btn-secondary btn-sm">신청 수락</a></td><!--자세히 보기 -->
							</tr>
						</c:forEach>	
