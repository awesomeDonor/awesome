...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
   ...
   function checkSession1(sessionData){
	   if(!sessionData){
		   alert('로그인을 해주세요!!');
		   window.location.href='./loginPage_Donor';
	   }else{
    ...
    <div class="row">
        ...
        <div class="col-2">
            ...
            <c:choose>
                ...
                <c:otherwise>
	                <a href="./loginPage_Donor" style="color:#736663;"><img src="${pageContext.request.contextPath}/resources/img/메뉴바_로그인.png" style="height: 22px; width: 138px;"></a>
                </c:otherwise>
            </c:choose>
            </div>
        </div>
        ...
        <div class="col">
            <div id="menubar">
                <ul class="nav nav-pills nav-justified" id="menubar2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href = "#" style="color:#736663;"><img src="${pageContext.request.contextPath}/resources/img/메뉴바_QnA.png" style="width: 138px; height: 22px;" onclick = "checkSession1('${sessionData }')"></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href = "#"><img src="${pageContext.request.contextPath}/resources/img/메뉴바_마이페이지.png" style="width: 138px; height: 22px; color:#736663;" onclick = "checkSession('${sessionData }')"></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"></a>
                    </li>
