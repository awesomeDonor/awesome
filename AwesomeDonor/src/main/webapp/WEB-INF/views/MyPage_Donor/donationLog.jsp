   ...
   <div class = row>
		...
		<div id="upborder" style=" margin: 30px 0px 0px 0px; width: 850px; height: 20px; border-radius: 5px 5px 0px 0px; background-color:#B4A8A1;"></div>
            ...
            <div id="tablebox" style="width: 800px; height: 450px; margin: 25px 10px 10px 25px;">
            	 <div class="row">
                    <div class="col p-0 m-0"><a href="./donationLog" class="btn btn-lg btn-block" style="background-color: rgb(219, 207, 203);" role="button"
                            aria-pressed="true">현재 진행중인 후원</a></div>
                    <div class="col p-0 m-0"><a href="./donationlogComplete" class="btn btn-lg btn-block" style="background-color: #E6E0D7;" role="button"
                            aria-pressed="true">완료된 후원</a></div>
                </div>
                <div class="row" style="width:55%; margin-top:10px;">
                    <div class="col">
                        <div class="list-group list-group-horizontal" style="font-size:13px; text-align:center; height:90%;" >
						  <a class="list-group-item list-group-item-action disabled ">정렬</a>
						  <a href="./donationLogsortName" class="list-group-item list-group-item-action ">기관이름 순</a>
						  <a href="./donationLogsortDate" class="list-group-item list-group-item-action ">후원 예정일 순</a>
						</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <table class="table tablePosition" style="font-size: 12px; color:#736663; text-align: center;">
                            <thead style=" background-color: #80716817">
                                <tr>
                                    ...
                                    <th scope="col">기관전화번호</th>
                                    <th scope="col">후원예정일</th>
                                </tr>
                            </thead>
                            <tbody style="overflow:scroll">        
                            	<c:forEach items="${boardData }" var="boardData">                    
		                            <tr>
		                                ...
		                                <td>${boardData.dto_Receiver.member_Receiver_phoneNumber }</td>
