...
<html lang="ko-kr">
  ...
  <body>
	...
	<div id="content_introduce" style="position:absolute; margin: -200px 0px 0px -370px; top: 50%; left: 50%; text-align: center;">
		<img src="${pageContext.request.contextPath}/resources/img/사이트소개.jpeg" style="width: 746px; height: 1517px;">
		<br>
		<br>
		<br>
		<br>
