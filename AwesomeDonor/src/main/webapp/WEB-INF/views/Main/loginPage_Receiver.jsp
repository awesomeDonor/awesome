...
function idcheck(){
    ...
    submitForm.setAttribute("action", "./loginProcess_Receiver");
...
function identificationComplete(identificationSuccess){
  ...
  <body>
  	...
  	<script>
  	identificationComplete(${identificationSuccess }');
  	</script>
  	</c:if>
            ...
            <div class = "container">
                ...
                <div class = row id = row3>
                        ...
                        <div class="col-md-6">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="./loginPage_Donor"><button type="button" class="btn btn-secondary">개인</button></a>
                                        <a href="./loginPage_Receiver"><button type="button" class="btn btn-secondary active">기관</button></a>
                                </div>
                        </div>
                        <div class="col-md-3"></div>
                </div>
                <div class = row id = row4>
                        <div class="col-md-12">
                                <form id = "f1">
                                    <div class="form-group">
                                        <div class = "row">
                                            ...
                                            <div class = col-md-6>
                                                <input name = Member_Receiver_idEmail type="email" class="form-control" aria-describedby="emailHelp" placeholder="이메일을 입력하세요!">
                                            </div>
                                            <div class = col-md-2> </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class = "row">
                                            ...
                                            <div class = col-md-6>
                                                <input name = Member_Receiver_pw type="password" class="form-control" placeholder="비밀번호를 입력하세요!!">
                                            </div>
                                            <div class = col-md-2> </div>
                                        </div>
                                    </div>
                            ...
                            <button type="submit" class="btn btn-primary" onclick = "idcheck()">로그인</button> <a href="./joinPage_Receiver" class="btn btn-info">회원가입</a> 
                        </div>   
                </div>
            </div>
    </div>
